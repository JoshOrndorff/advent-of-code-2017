...
// 2756 is too low
  ...
  solve: function(){
    // Parse the input
    var lengths = parseOnelineInput().map(Number)

    // Create the list and other state variables
    var state = getFreshState()

    // Do the actual hashing
    singleHashRound(state, lengths)

    var answer = state.arr[0] * state.arr[1]
...
var part2 = {
  solve: function(){
    ...
    //TODO Actually make the dense hash into ascii code
    var answer = ""
